...
Link do Conteúdo : [Entidade Relacionamento](https://www.youtube.com/watch?v=xN7B-_9YqAE)

## Abordagem entidade relacionamento

MER(Modelo Entidade Relacionamento)

modelo conceitual para descrever as entidades (objetos), seus atributos(características) e como elas se relacionam(relacionamento)

### Entidades(objetos)

`Física`: Existem no mundo real.
Exemplos: Aluno, livro, Automóvel.
