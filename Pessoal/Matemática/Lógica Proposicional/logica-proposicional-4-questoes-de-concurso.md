---
titulo: "Lógica Proposicional 4 — Questões de Concurso"
tags: [logica-proposicional, conectivos-logicos, resolucao-de-exercicios, matematica]
data: 2026-08-17
fonte: "gravação (sistema)"
tipo: transcricao
duracao_min: 16
conceitos: [Conjunção, Disjunção, Condicional, Bicondicional, Negação]
---

# Lógica Proposicional 4 — Questões de Concurso

> [!resumo] Do que se trata
> Aula sobre conectivos lógicos, ensinando a resolver questões de concurso com lógica proposicional. Aulas anteriores foram sobre lógica proposicional e conectivos.
...
- Como resolver questões de concurso com lógica proposicional?
- Como identificar o conectivo escondido em "somente se"?
- Como resolver primeiro o parêntese e depois a negação de fora?

## Conceitos

**Conjunção** · **Disjunção** · **Condicional** · **Bicondicional** · **Negação**

## Conteúdo

`⏱ 00:00`

Nos últimos vídeos, estamos falando sobre lógica proposicional. Quem ainda não viu os outros vídeos de lógica proposicional, eu sugiro que veja primeiro. Foram três vídeos nos quais eu explico os conectivos, as proposições e as regras principais da lógica.
...
Dadas as proposições simples P e Q, tal que P é verdadeira. É super importante ver que o autor traz para nós o valor lógico. Não precisa quebrar a cabeça. Se for coisa de matemática, você tem que julgar se é verdade ou se é falso. Caso não seja, o autor vai trazer, então P é verdadeira e Q é falso.
...
Ainda vou falar das equivalências das negações e ainda tem quantificadores.
...
- Faz o que mais, ativa o sininho aqui para ouvir as mensagens do Instagram, se inscreve e dá um like, bom?
- Bem-vindos ao canal Descomplicando RLM e Corvaguinho.
- **Dica:** Peçam lá no Instagram um resumo teórico que eu fiz sobre esse assunto.
- Obrigado pela audiência.
- Compartilhe o vídeo pelo WhatsApp.
- Manda aí para a prima, para o primo que quer estudar, para o sobrinho que está precisando passar em concurso.
- Um beijo grande.
- Fiquem em paz.
- Estamos juntos.
