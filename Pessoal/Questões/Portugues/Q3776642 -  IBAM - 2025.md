...
A **Oração Principal** é aquela que serve de "base" para outra, mas que geralmente está incompleta do ponto de vista sintático. Ela precisa que uma oração subordinada venha preencher o buraco(atuando como seu sujeito, seu objeto direto, etc.)

Vamos analisar o bloco em destaque: "**É indubitável**"

- Temos o verbo de ligação ("É")
- Temos o predicativo ("indubitável")
- **O que esta faltando**? O sujeito! quem ou o que é indubitável?

Como a oração principal não tem sujeito próprio, ela "obriga" a oração seguinte a funcionar como o sujeito dela. (É como se disséssemos: "ISSO é indubitável")
